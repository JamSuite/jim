...
│   ├── verify/              # /jim:verify — invariant + contract-graph verification engine (035–037)
│   │   ├── SKILL.md
│   │   ├── references/
│   │   │   └── contracts-methodology.md  # cross-group edge semantics, facts-vs-verdicts, dead-surface set logic (037)
│   │   └── scripts/
│   │       └── jimverify.sh           # deterministic core — parse / territory / check / faces / edges / contracts-check verbs
...
- **Location:** `docs/specs/{group}/{00X}-{name}/` — currently `docs/specs/jim/001-meta/` through `036-verify-loop/`
