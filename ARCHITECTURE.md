...
│   │   └── scripts/
│   │       └── jimverify.sh           # deterministic core — parse / territory / check / faces / edges / contracts-check / health verbs
...
- **Location:** `docs/specs/{group}/{00X}-{name}/` — currently `docs/specs/jim/001-meta/` through `039-graph-health/`
