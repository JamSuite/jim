...
│   ├── blueprint/           # /jim:blueprint — per-group current-state spec generation + review/ad-hoc update (030)
...
│   │   └── jim/             # Specs for jim's own development (001–030)
...
- **Location:** `docs/specs/{group}/{00X}-{name}/` — currently `docs/specs/jim/001-meta/` through `030-blueprint-update/`
