...
│   ├── blueprint/           # /jim:blueprint — per-group blueprint generation + guarded review/ad-hoc update (030/031)
...
- **Location:** `docs/specs/{group}/{00X}-{name}/` — currently `docs/specs/jim/001-meta/` through `031-blueprint-update-guard/`
