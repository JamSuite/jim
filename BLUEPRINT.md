...
*Last updated: 2026-07-23 (via /jim:blueprint)*
...
- **Boundary rationale:** Deliberately a single bounded context. The plugin
  ...
  boundary. Visible future seams — the issue-tracking cluster, the review
  pipeline, the blueprint machinery, and the verification engine — remain
  internal clusters until cross-cluster contracts would earn their keep.
...
on every blueprint write; do not edit. Last reconciled: 2026-07-23T23:32:37Z
(via /jim:blueprint)*
