...
- `docs/specs/jim/011-directive-vocabulary/spec.md:63-65` — the Regression-matrix AC block that names `.claude/skills/subtest/` → `.claude/skills/meta-matrix/` rename and the ARCHITECTURE.md fixture reference. Spec 014 amends these references in place; 011's behavioral ACs (sentinel migrations, lean IF) are unchanged.
