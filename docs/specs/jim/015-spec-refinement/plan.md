...
spec: "docs/specs/jim/015-spec-refinement/spec.md"
type: feature
status: complete
---
...
| No writes to sensitive paths (`.git/`, `~/.ssh/`, `node_modules/`, `.venv/`, `.env*`) | Yes | All writes target `agents/`, `skills/spec/`, `skills/spec-check/`, or `docs/specs/jim/015-*/` — none sensitive. |
...
- Retrofitting historical specs (`docs/specs/jim/001-014`) to the new template — they remain as-is.
