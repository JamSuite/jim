...
the parent's active model — `docs/specs/jim/014-meta-matrix/plan.md:97-130`). No
jim runtime evidence exists for a per-spawn model override
(`docs/specs/jim/014-meta-matrix/research.md:71` rejects the related env-var read).
