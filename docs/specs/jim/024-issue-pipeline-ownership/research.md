...
- `docs/specs/jim/018-issue-tracking-workflow-integration/spec.md:60-62` — the "**Security and Safety**" AC (untrusted-content rule) the skills cite. This is the *only* candidate-batch contract single-sourced in 018; the Resolution/Actionability filters are **not** defined here — they live only in the skill bodies.
