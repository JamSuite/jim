...
- **`docs/specs/platform/001-jimconf/research.md`** — primary local prior art. Establishes the script-as-deterministic-resolver pattern, `${CLAUDE_PLUGIN_ROOT}` substitution, no-`source` security model, and test-runner conventions. **The new utility is a direct sibling.**
