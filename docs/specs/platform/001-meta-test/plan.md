...
spec: "docs/specs/platform/001-meta-test/spec.md"
type: feature
status: complete
---
...
| Spec 008 forward-ref | `docs/specs/platform/002-jimconf/spec.md` | Update | Append "Note (added by spec 007)" paragraph in the testing section (after L76). Additive only. |
| Plan 008 forward-ref | `docs/specs/platform/002-jimconf/plan.md` | Update | Append "Note (added by spec 007)" paragraph in Decision 4 region. Additive only. |
| Spec 009 forward-ref | `docs/specs/platform/003-jimfile/spec.md` | Update | Append "Note (added by spec 007)" paragraph in the testing section (after L60). Additive only. |
| Plan 009 forward-ref | `docs/specs/platform/003-jimfile/plan.md` | Update | Append "Note (added by spec 007)" paragraph in Decision 9 region. Additive only. |
...
13. [x] **Append forward-reference paragraph to `docs/specs/platform/002-jimconf/spec.md`** after the testing-strategy resolution at L76. Format: a `> **Note (added by spec 007):** Tests for jimconf now follow the conventions ratified by spec 007 (`/jim:meta-test`). The framework lives at `skills/meta-test/scripts/testlib.sh`; new test cases should be scaffolded via `/jim:meta-test add jimconf <case_name>`.` blockquote. Additive only; no existing content modified.
    **Verify:** `grep -q 'added by spec 007' docs/specs/platform/002-jimconf/spec.md`

14. [x] **Append forward-reference paragraph to `docs/specs/platform/002-jimconf/plan.md`** in the Decision 4 region (testing strategy). Same format and content scope as Task 13.
    **Verify:** `grep -q 'added by spec 007' docs/specs/platform/002-jimconf/plan.md`

15. [x] **Append forward-reference paragraph to `docs/specs/platform/003-jimfile/spec.md`** after L60 (the testing AC). Same format, scoped to jimfile.
    **Verify:** `grep -q 'added by spec 007' docs/specs/platform/003-jimfile/spec.md`

16. [x] **Append forward-reference paragraph to `docs/specs/platform/003-jimfile/plan.md`** in the Decision 9 region (test runner). Same format, scoped to jimfile.
    **Verify:** `grep -q 'added by spec 007' docs/specs/platform/003-jimfile/plan.md`
