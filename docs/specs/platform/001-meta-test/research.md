...
- `docs/specs/platform/002-jimconf/spec.md:75-76` — Open Question on testing strategy, resolved with reference to `tests/run.sh`. Insert "Note (added by spec 007)" forward-reference paragraph after L76.
- `docs/specs/platform/003-jimfile/spec.md:59-60` — AC mentioning "tests/" with "zero-dependency and strict-documentation conventions established by 007". Insert forward-reference paragraph after L60.
