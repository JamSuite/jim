...
spec: "docs/specs/sdlc/013-sec/spec.md"
type: feature
status: complete
---
...
| No sensitive path writes | Yes | All writes are to `docs/specs/sdlc/013-sec/`, `skills/sec/`, `agents/security.md`, `jimconf.toml.example`, `tests/jimconf.sh`, `skills/spec/SKILL.md`, `skills/plan/SKILL.md`, `skills/build/SKILL.md`, `skills/conf/scripts/jimconf.sh` |
...
1. Developer runs `/jim:build docs/specs/sdlc/013-sec`.
...
1. Developer manually runs `/jim:sec docs/specs/sdlc/013-sec` before invoking `/jim:build`. `/jim:sec` writes `security.md` with `reviewed_phases: [spec, plan]`.
