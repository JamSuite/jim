...
**Haberlah — *How to write PRDs for AI Coding Agents*** ([source](https://medium.com/@haberlah/how-to-write-prds-for-ai-coding-agents-d60d72efb797); re-verified first-hand 2026-07-17 — content below confirmed)
...
**GitHub spec-kit — `templates/commands/specify.md`** ([source](https://github.com/github/spec-kit/blob/main/templates/commands/specify.md); re-verified first-hand 2026-07-17 via raw file — Razor, success-criteria gates, over-specification bad-examples, and the "Maximum 3 [NEEDS CLARIFICATION] markers total" cap all confirmed verbatim)
