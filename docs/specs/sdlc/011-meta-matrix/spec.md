...
origin:
  ...
  - "docs/specs/sdlc/008-directive-vocabulary/spec.md"
...
- [ ] `docs/specs/sdlc/008-directive-vocabulary/plan.md` and `research.md` (if either references `.claude/skills/meta-matrix/`) are similarly amended in place. Body of the historical record preserved otherwise.
