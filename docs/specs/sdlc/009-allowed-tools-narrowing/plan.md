...
spec: "docs/specs/sdlc/009-allowed-tools-narrowing/spec.md"
type: refactor
status: approved
---
...
27. [x] Confirm `docs/specs/sdlc/009-allowed-tools-narrowing/spec.md` ACs 10–15 have been rewritten to match the new strategy (this is bookkeeping — verifies the spec amendment landed cleanly). Spec amendment performed manually as part of this revert pass.
    **Verify:** `grep -Fq 'No `skills/*/SKILL.md` declares a `Read(${CLAUDE_SKILL_DIR}/...)` clause' docs/specs/sdlc/009-allowed-tools-narrowing/spec.md && grep -Fq 'main-thread execution' docs/specs/sdlc/009-allowed-tools-narrowing/spec.md && grep -Fq 'README.md` contains a "Permissions" section' docs/specs/sdlc/009-allowed-tools-narrowing/spec.md`
