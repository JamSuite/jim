---
spec: docs/specs/sdlc/002-pm-core/spec.md
type: feature
---
...
| `docs/specs/sdlc/001-meta/` | Completed spec group. Pattern reference for spec directory structure, frontmatter, and research/plan co-location. |
...
| 10 | 001-meta research | Local reference | `docs/specs/sdlc/001-meta/research.md` |
