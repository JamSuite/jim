...
```
> /jim:plan docs/specs/issue/002-issue-tracking-workflow-integration
...
I noted 4 candidate issues during planning:
  ...
  [x] 1. Per-skill opt-out config for issue capture
        ...
        origin: docs/specs/issue/002-issue-tracking-workflow-integration/plan.md
